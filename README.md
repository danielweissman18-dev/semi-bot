...
- **📅 דיווח בוקר** – כל יום ב-9:30 – סטטוס כל הלקוחות נשלח ישירות לטלגרם למשתמשים רשומים
- **💾 Storage לצמיתות** – לקוחות נשמרים ב-`clients.json`, והצ'אטים הרשומים נשמרים ב-`chatIds.json`
